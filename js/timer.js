if ($(".landing-block .counter").length) {
    setTimeout(
        function () {
...
$('.countdown').downCount({
    date: '10/29/2015 12:00:00'
    // month/day
});

$(function() {
    if ($('.round-page').length) {
...
var showLandingRegistration =  setTimeout(function() {
    $(".popup.registration.large").addClass("active");
},5000);
